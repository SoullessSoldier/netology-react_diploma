...
Со стоимостью товара при операции с корзиной вообще серая зона - если в момент оформления заказа цена на сервере поменяется?
...
**На сайте нужно разместить Политику обработки персональных данных**
...
- [X] при добавлении еще одной пары товар-размер в корзину возникает ошибка в редьюсере